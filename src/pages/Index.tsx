...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="px-6 py-10 text-center">
        <h2 className="font-display text-3xl font-bold leading-tight text-foreground sm:text-5xl">
          Create Stunning Posts<br /><span className="gradient-text">In One Click</span>
        </h2>
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
          Select a template, pick your business, and let AI generate a professional branded post instantly.
        </p>
      </motion.section>
